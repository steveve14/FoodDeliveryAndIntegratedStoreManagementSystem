...
public class OrderGrpcServiceImpl extends OrderGrpcServiceGrpc.OrderGrpcServiceImplBase {
    ...
    @Override
    public void createOrder(CreateOrderGrpcRequest request, StreamObserver<OrderResponse> responseObserver) {
        try {
            OrderDto dto = orderService.createOrder(request.getUserId(), "CREATED");
            responseObserver.onNext(OrderResponse.newBuilder()
                    .setFound(true)
                    .setOrderId(dto.getId())
                    .setUserId(dto.getUserId())
    ...
    @Override
    public void getOrdersByUserId(GetOrdersByUserIdRequest request, StreamObserver<OrderListResponse> responseObserver) {
