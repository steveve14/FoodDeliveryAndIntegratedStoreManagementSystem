...
public class OrderGrpcServiceImpl extends OrderGrpcServiceGrpc.OrderGrpcServiceImplBase {
  ...
  @Override
  public void getOrderById(GetOrderByIdRequest request,
  ...
  @Override
  public void createOrder(CreateOrderGrpcRequest request,
      StreamObserver<OrderResponse> responseObserver) {
    try {
      ...
      for (var it : request.getItemsList()) {
        items.add(new com.example.order.dto.OrderItemDto(it.getProductId(), it.getQuantity(),
            it.getPrice()));
      }
  ...
  @Override
  public void getOrdersByUserId(GetOrdersByUserIdRequest request,
